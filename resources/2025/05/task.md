...
figure out which of their ingredients are **fresh** and which are **spoiled**.
...
So, in this example, <code>**3**</code> of the available ingredient IDs are fresh.
...
**fresh ingredient ID ranges** consider to be fresh.
...
`17`, `18`, `19`, and `20`.
So, in this example, the fresh ingredient ID ranges consider a total of <code>**14**</code> ingredient IDs to be fresh.
