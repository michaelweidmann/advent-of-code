...
displaying 0-50 <span style="color:yellow">stars</span>.

Your instincts tell you that in order to save Christmas, you'll need to get all <span style="color:yellow">fifty
stars</span> by December 25th.

Collect stars by solving puzzles. Two puzzles will be made available on each day in the Advent calendar; the second
puzzle is unlocked when you complete the first. Each puzzle grants  <span style="color:yellow">one star</span>. Good
luck!
